...
public class LevelsView4 extends View
{
    ...
    public static final String LEVEL1 = "Level10";

    public static final String LEVEL2 = "Level11";
    public static final String LEVEL3 = "Level12";

    private static String L1Icon = "/10.png";
    private static String L2Icon = "/11.png";
    private static String L3Icon= "/12.png";
