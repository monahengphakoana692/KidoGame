...
public class MaeleGame extends View {
    ...
    private VBox createQuestionView(int levelIndex) {
        ...
        String[][][] questions = {
                // Category 0
                {
                        {"Khomo ea lebese ha e itsoale?", "Ha ho motho a iketsetsang lintho", "Hase ha ngata ngoana aka futsang Motsoali ka matla ", "Batho ba thusana", "Motho a phelang ka litsietse", "1"},
                ...
                // Category 1
                {
                        ...
                        {"Khome e thibela lerumo? ", "Likhobe","LIerekise", "Limathi", "Ntate mohole le Nkhono", "0"},
                        {"Nama e ka mpeng ho khome?", "Lihaba ha li hola", "Khomo", "Mokopu ha u nama", "Lebese", "2"}
                },
                // Category 2
                {
                        {"Moketa Khomo o nonela tlhakong?", "Likobo", "Lefats'e", "Leholimo le Lefats'e", "Leholimo", "2"},
