...
public class LijoGame extends View {
    ...
    private MediaView questionVideoView;
    private LevelsView5 levelsView = new LevelsView5();
    ...
    private VBox createResultsView(int correctCount) {
        ...
        if (correctCount == LEVELS_PER_CATEGORY) {
            if (currentCategory < 14) { // If not the last category
    ...
    private void HoldMediaPlayers() {
        ...
        if (questionMediaPlayer != null) questionMediaPlayer.stop();
    }
    ...
    protected void updateAppBar(AppBar appBar) {
        ...
        appBar.setTitleText("PAPALI KA LIJO - BOEMO KE: " + currentCategory);
    }
